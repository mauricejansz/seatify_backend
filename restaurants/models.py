...
class Review(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        self.restaurant.update_rating()  # Update restaurant's average rating
...
class SavedRestaurant(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="saved_restaurants")  # Tracks user
