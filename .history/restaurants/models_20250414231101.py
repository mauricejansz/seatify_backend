...
class Restaurant(models.Model):
    ...
    image = models.ImageField(
        upload_to='restaurant_images', blank=False, null=True)
    rating = models.FloatField(default=0.0)  # Stores the average rating
    user = models.ForeignKey(settings.AUTH_USER_MODEL,
                             on_delete=models.CASCADE, related_name="restaurants")
...
class Slot(models.Model):
    ...
    table = models.ForeignKey(
        Table, on_delete=models.CASCADE, related_name="slots")
    customer_name = models.CharField(
        max_length=120, blank=True, null=True)  # NEW
...
class SavedRestaurant(models.Model):
    ...
    restaurant = models.ForeignKey(
        "restaurants.Restaurant", on_delete=models.CASCADE, related_name="saved_by_users")
