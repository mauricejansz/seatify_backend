...
class RestaurantSerializer(serializers.ModelSerializer):
    ...
    menu_items = MenuItemSerializer(source="categories.menu_items", many=True, read_only=True)
...
class ReviewSerializer(serializers.ModelSerializer):
    ...
    user_name = serializers.ReadOnlyField(source='user.username')  # Include username

    class Meta:
        model = Review
        fields = ["id", "user_id", "user_name", "restaurant_id", "name", "rating", "comment"]
